...
foreach ($AgentName in $Agent) {
  ...
  $Required = @(
    ...
    "assets\templates\CONTEXT.md",
    "assets\templates\SKILL-ANATOMY.md",
    "assets\templates\TASKS.yaml",
    "assets\templates\TASKS.index.yaml",
    "assets\templates\tasks\TASK-001.yaml",
    "assets\templates\AGENTS.narrative.md",
    "assets\templates\SECURITY.md",
    "assets\templates\dependabot.yml",
    "assets\templates\CODEOWNERS",
    "assets\templates\contracts\openapi\openapi.yaml",
    "assets\security-checklists\general.md",
    "assets\agent-surfaces\.cursor\rules-scoped\project-conventions.mdc",
    "assets\ci\hooks\pre-commit",
    "assets\ci\workflows\forge-governance.yml",
    ...
    "assets\scripts\forge_migrate_context.py",
    "assets\scripts\forge_validate_context.py",
