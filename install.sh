...
echo "  3. In slash-command IDEs, subskills are grouped as /forge-*."
echo "  4. If the repo has no FORGE docs yet, start with:"
echo "     Use the forge skill or /forge-bootstrap to create docs/forge for this project."
